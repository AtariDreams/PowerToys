...
namespace ColorPicker.Shaders
{
    public class GridShaderEffect : ShaderEffect
    {
        ...
        public static readonly DependencyProperty RadiusProperty = DependencyProperty.Register(nameof(Radius), typeof(double), typeof(GridShaderEffect), new UIPropertyMetadata(0D, PixelShaderConstantCallback(2)));
        public static readonly DependencyProperty SquareSizeProperty = DependencyProperty.Register(nameof(SquareSize), typeof(double), typeof(GridShaderEffect), new UIPropertyMetadata(0D, PixelShaderConstantCallback(3)));
        public static readonly DependencyProperty TextureSizeProperty = DependencyProperty.Register(nameof(TextureSize), typeof(double), typeof(GridShaderEffect), new UIPropertyMetadata(0D, PixelShaderConstantCallback(4)));
